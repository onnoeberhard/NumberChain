...
def getLiteralNumber(n):
    if n < 20:
        ...
        return words[int(str(n)[:1]) * 10] + (words[int(str(n)[1:])] if int(str(n)[1:]) > 0 else "")
    elif n < 1000:
        return words[int(str(n)[:1])] + words[100] + (words[int(str(n)[1:2]) * 10] if int(str(n)[1:2]) > 0 else "") + \
        ...
        return words[int(str(n)[:1]) * 10] + (words[int(str(n)[1:2])] if int(str(n)[1:2]) > 0 else "") + words[1000] + \
                 (words[int(str(n)[2:3])] + words[100] if int(str(n)[2:3]) > 0 else "") + (
                     words[int(str(n)[3:4]) * 10] if int(str(n)[3:4]) > 0 else "") + \
                 (words[int(str(n)[4:])] if int(str(n)[4:]) > 0 else "")
    elif n < 1000000:
